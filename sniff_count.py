...
class Sniffer_Coung:
    def __init__(self):
        ...
        self.options = {"packet_count":20, "packet_filter":"default", "interface":"eth0"}
    ...
    def printOptions(self):
        ...
        print("packet_cap (packets to collect before calculating time delta): {}".format(self.options["packet_count"]))
